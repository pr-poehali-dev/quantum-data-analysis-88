...
const featureCards = [
  ...
  {
    title: "Точность и соответствие нормам",
    illustration: (
      <div className="relative w-full h-full flex items-center justify-center overflow-hidden">
        <img
          ...
          <div className="flex flex-col lg:flex-row lg:items-start lg:justify-between gap-8 mb-16">
            ...
            >
              <p className="text-zinc-400 leading-relaxed">
                SafeTrack построен на требованиях Трудового кодекса, ПТЭЭП и правил пожарной безопасности:
                автоматический контроль периодичности, полноты и фиксация результатов проверок.{" "}
